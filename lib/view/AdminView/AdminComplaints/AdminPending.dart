                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Center(
                                                                                child: TextButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    Api().post("${MyConfig.nodeUrl}/complaint/updatePriority", data: {
                                                                                      "id": pdata[index].id,
                                                                                      "name": _selectedPriority == 0
                                                                                          ? "Low"
                                                                                          : _selectedPriority == 1
                                                                                              ? "Medium"
                                                                                              : "High"
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Center(
                                                                                child: TextButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    Api().post("${MyConfig.nodeUrl}/complaint/updateStatus", data: {
                                                                                      "id": pdata[index].id,
                                                                                      "name": _selectedOption == 0
                                                                                          ? "Pending"
                                                                                          : _selectedOption == 1
                                                                                              ? "Hold"
                                                                                              : "Solved"
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                makeTwoline(
                                    "Status:", pdata[index].status, context),
                                SizedBox(
                                  height: height * 0.01,
                                ),
                                makeTwoline("Ward No:",
